...
$category = $categoryManager->index();
...
<div class="container">
  ...
  <div class="col-md-8">
    <h4>Category List</h4>
    <!-- ------------------- -->
    <form class="form-inline my-2 my-lg-0" style="float: right; padding: 0em 17em 0em 0em;" method="post" action="search.php">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="edit.php?id=<?php echo $item->getId()?>" class="btn btn-success">Update</a></td>
